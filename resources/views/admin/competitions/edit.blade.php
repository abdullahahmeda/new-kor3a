...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.competitions.update', $competition) }}" class="pb-4" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="trip_at" name="trip_at" onchange="setTripMaxDate()" value="{{ old('trip_at') ?? $competition->trip_at }}" required>
            @error('trip_at')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="finish_at" name="finish_at" value="{{ old('finish_at') ?? $competition->finish_at }}" required>
            <small>
